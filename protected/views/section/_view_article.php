...
<div class='view'>
	...
	<div>
	 	...
	 	<?php echo CHtml::link( 'Download' , array('article/articleDownload' ,'id_article' =>$data->id_article , 'id_article_version' =>$data->getCurrentVersion()->id_article_version ),array('target'=>'_blank')) ?>
	</div>
</div>